...
function(e) { "use strict"; "object" == typeof module && "object" == typeof module.exports ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : e() }(function() {
        ...
        return function(e, t, r, a) {
                ...
                function i(e) { return x.isWrapped(e) ? e = v.call(e) : x.isNode(e) && (e = [e]), e }
                ...
                function c(e, r, a, n) {
                    ...
                    var P = w ? new Float32Array(b) : new Array(b),
                        V = !1,
                        k = function(t) { return V || g(), e === r && a === n ? t : 0 === t ? 0 : 1 === t ? 1 : l(d(t), r, n) };
                    k.getControlPoints = function() { return [{ x: e, y: r }, { x: a, y: n }] };
                    var T = "generateBezier(" + [e, r, a, n] + ")";
                    return k.toString = function() { return T }, k
                }

                function p(e, t) { var r = e; return x.isString(e) ? V.Easings[e] || (r = !1) : r = x.isArray(e) && 1 === e.length ? u.apply(null, e) : x.isArray(e) && 2 === e.length ? k.apply(null, e.concat([t])) : !(!x.isArray(e) || 4 !== e.length) && c.apply(null, e), !1 === r && (r = V.Easings[V.defaults.easing] ? V.defaults.easing : P), r }
                                    ...
                                    if (o(C)) {
                                        ...
                                        if (u.display !== a && null !== u.display && "none" !== u.display) {
                                            if ("flex" === u.display) {
                                                ...
                                                g.each(E, function(e, t) { T.setPropertyValue(C, "display", t) })
                                            }
                ...
                function d(e, t) {
                    ...
                    for (var r = V.State.calls[e][0], n = V.State.calls[e][1], i = V.State.calls[e][2], s = V.State.calls[e][4], l = !1, u = 0, c = r.length; u < c; u++) {
                        ...
                        if (!t && i.complete && !i.loop && u === c - 1) try { i.complete.call(n, n) } catch (e) { setTimeout(function() { throw e }, 1) } s && !0 !== i.loop && s(n), f && !0 === i.loop && !t && (g.each(f.tweensContainer, function(e, t) {
                            if (/^rotate/.test(e) && (parseFloat(t.startValue) - parseFloat(t.endValue)) % 360 == 0) {
                                var r = t.startValue;
                                t.startValue = t.endValue, t.endValue = r
                            }
                            /^backgroundPosition/.test(e) && 100 === parseFloat(t.endValue) && "%" === t.unitType && (t.endValue = 0, t.startValue = 100)
                        }), V(p, "reverse", { loop: !0, delay: i.delay })), !1 !== i.queue && g.dequeue(p, i.queue)
                    }
                    V.State.calls[e] = !1;
                    for (var m = 0, h = V.State.calls.length; m < h; m++)
                        if (!1 !== V.State.calls[m]) { l = !0; break }!1 === l && (V.State.isTicking = !1, delete V.State.calls, V.State.calls = [])
                }
                var g, m = function() { if (r.documentMode) return r.documentMode; for (var e = 7; e > 4; e--) { var t = r.createElement("div"); if (t.innerHTML = "\x3c!--[if IE " + e + "]><span></span><![endif]--\x3e", t.getElementsByTagName("span").length) return t = null, e } return a }(),
                    ...
                    v = function() {
                        ...
                        try { return e.call(r.documentElement), e } catch (t) {
                            return function(t, r) {
                                var a = this.length;
                    ...
                    x = {
                        ...
                        isWrapped: function(e) { return e && e !== t && x.isNumber(e.length) && !x.isString(e) && !x.isFunction(e) && !x.isNode(e) && (0 === e.length || x.isNode(e[0])) },
                ...
                if (!(m <= 7)) {
                    var S = 400,
                        ...
                        V = {
                            ...
                            Easings: {},
                            Promise: t.Promise,
                            defaults: { queue: "", duration: S, easing: P, begin: a, complete: a, progress: a, display: a, visibility: a, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0, promiseRejectEmpty: !0 },
                            init: function(e) { g.data(e, "velocity", { isSVG: x.isSVG(e), isAnimating: !1, computedStyle: null, tweensContainer: null, rootPropertyValueCache: {}, transformCache: {} }) },
                            hook: null,
                            mock: !1,
                            ...
                            pauseAll: function(e) {
                                ...
                                }), g.each(V.State.delayedElements, function(e, r) { r && s(r, t) })
                            },
                            resumeAll: function(e) {
                                ...
                                }), g.each(V.State.delayedElements, function(e, r) { r && l(r, t) })
                            }
                        };
                    ...
                    V.Easings = { linear: function(e) { return e }, swing: function(e) { return .5 - Math.cos(e * Math.PI) / 2 }, spring: function(e) { return 1 - Math.cos(4.5 * e * Math.PI) * Math.exp(6 * -e) } }, g.each([
                                ["ease", [.25, .1, .25, 1]],
                                ["ease-in", [.42, 0, 1, 1]],
                                ["ease-out", [0, 0, .58, 1]],
                ...
                ["easeInOutCirc", [.785, .135, .15, .86]]
                        ...
                        function e(e, t, r) { if ("border-box" === T.getPropertyValue(t, "boxSizing").toString().toLowerCase() === (r || !1)) { var a, n, i = 0,
                                    o = "width" === e ? ["Left", "Right"] : ["Top", "Bottom"],
                                    s = ["padding" + o[0], "padding" + o[1], "border" + o[0] + "Width", "border" + o[1] + "Width"]; for (a = 0; a < s.length; a++) n = parseFloat(T.getPropertyValue(t, s[a])), isNaN(n) || (i += n); return r ? -i : i } return 0 }
                        ...
                        function t(t, r) { return function(a, n, i) { switch (a) {
                                    ...
                                    case "inject":
                                        return parseFloat(i) - e(t, n, r) + "px" } } } m && !(m > 9) || V.State.isGingerbread || (T.Lists.transformsBase = T.Lists.transformsBase.concat(T.Lists.transforms3D)); for (var r = 0; r < T.Lists.transformsBase.length; r++) ! function() { var e = T.Lists.transformsBase[r];
                            T.Normalizations.registered[e] = function(t, r, n) { switch (t) {
                                    case "name":
                                        return "transform";
                                    case "extract":
                                    ...
                                    case "inject":
                                        var i = !1; switch (e.substr(0, e.length - 1)) {
                                            ...
                                            case "scal":
                                            case "scale":
                                                V.State.isAndroid && o(r).transformCache[e] === a && n < 1 && (n = 1), i = !/(\d)$/i.test(n); break;
                                            case "skew":
                                            case "rotate":
                                                i = !/(deg|\d)$/i.test(n) } return i || (o(r).transformCache[e] = "(" + n + ")"), o(r).transformCache[e] } } }(); for (var n = 0; n < T.Lists.colors.length; n++) ! function() { var e = T.Lists.colors[n];
                            T.Normalizations.registered[e] = function(t, r, n) { switch (t) {
                                    case "name":
                                        return e;
                                    case "extract":
                                        var i; if (T.RegEx.wrappedValueAlreadyExtracted.test(n)) i = n;
                        ...
                        T.Normalizations.registered.innerWidth = t("width", !0), T.Normalizations.registered.innerHeight = t("height", !0), T.Normalizations.registered.outerWidth = t("width"), T.Normalizations.registered.outerHeight = t("height") } }, Names: { camelCase: function(e) { return e.replace(/-(\w)/g, function(e, t) { return t.toUpperCase() }) }, SVGAttribute: function(e) { var t = "width|height|x|y|cx|cy|r|rx|ry|x1|x2|y1|y2"; return (m || V.State.isAndroid && !V.State.isChrome) && (t += "|transform"), new RegExp("^(" + t + ")$", "i").test(e) }, prefixCheck: function(e) { if (V.State.prefixMatches[e]) return [V.State.prefixMatches[e], !0]; for (var t = ["", "Webkit", "Moz", "ms", "O"], r = 0, a = t.length; r < a; r++) { var n; if (n = 0 === r ? e : t[r] + e.replace(/^\w/, function(e) { return e.toUpperCase() }), x.isString(V.State.prefixElement.style[n])) return V.State.prefixMatches[e] = n, [n, !0] } return [e, !1] } }, Values: { hexToRgb: function(e) { var t, r = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
                    ...
                    function s(e, r) { var n = 0; if (m <= 8) n = g.css(e, r);
                        else { var l = !1; /^(width|height)$/.test(r) && 0 === T.getPropertyValue(e, "display") && (l = !0, T.setPropertyValue(e, "display", T.Values.getDisplayType(e))); var u = function() { l && T.setPropertyValue(e, "display", "none") }; if (!i) { if ("height" === r && "border-box" !== T.getPropertyValue(e, "boxSizing").toString().toLowerCase()) { var c = e.offsetHeight - (parseFloat(T.getPropertyValue(e, "borderTopWidth")) || 0) - (parseFloat(T.getPropertyValue(e, "borderBottomWidth")) || 0) - (parseFloat(T.getPropertyValue(e, "paddingTop")) || 0) - (parseFloat(T.getPropertyValue(e, "paddingBottom")) || 0); return u(), c } if ("width" === r && "border-box" !== T.getPropertyValue(e, "boxSizing").toString().toLowerCase()) { var p = e.offsetWidth - (parseFloat(T.getPropertyValue(e, "borderLeftWidth")) || 0) - (parseFloat(T.getPropertyValue(e, "borderRightWidth")) || 0) - (parseFloat(T.getPropertyValue(e, "paddingLeft")) || 0) - (parseFloat(T.getPropertyValue(e, "paddingRight")) || 0); return u(), p } } var f;
                            f = o(e) === a ? t.getComputedStyle(e, null) : o(e).computedStyle ? o(e).computedStyle : o(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === r && (r = "borderTopColor"), "" !== (n = 9 === m && "filter" === r ? f.getPropertyValue(r) : f[r]) && null !== n || (n = e.style[r]), u() } if ("auto" === n && /^(top|right|bottom|left)$/i.test(r)) { var d = s(e, "position");
                            ("fixed" === d || "absolute" === d && /top|left/i.test(r)) && (n = g(e).position()[r] + "px") } return n } var l; if (T.Hooks.registered[r]) { var u = r,
                            c = T.Hooks.getRoot(u);
                        n === a && (n = T.getPropertyValue(e, T.Names.prefixCheck(c)[0])), T.Normalizations.registered[c] && (n = T.Normalizations.registered[c]("extract", e, n)), l = T.Hooks.extractValue(u, n) } else if (T.Normalizations.registered[r]) { var p, f; "transform" !== (p = T.Normalizations.registered[r]("name", e)) && (f = s(e, T.Names.prefixCheck(p)[0]), T.Values.isCSSNullValue(f) && T.Hooks.templates[r] && (f = T.Hooks.templates[r][1])), l = T.Normalizations.registered[r]("extract", e, f) } if (!/^[\d-]/.test(l)) { var d = o(e); if (d && d.isSVG && T.Names.SVGAttribute(r))
                            if (/^(height|width)$/i.test(r)) try { l = e.getBBox()[r] } catch (e) { l = 0 } else l = e.getAttribute(r);
                            else l = s(e, T.Names.prefixCheck(r)[0]) } return T.Values.isCSSNullValue(l) && (l = 0), V.debug >= 2 && console.log("Get " + r + ": " + l), l }, setPropertyValue: function(e, r, a, n, i) { var s = r; if ("scroll" === r) i.container ? i.container["scroll" + i.direction] = a : "Left" === i.direction ? t.scrollTo(a, i.alternateValue) : t.scrollTo(i.alternateValue, a);
                    ...
                    else { if (T.Hooks.registered[r]) { var l = r,
                                u = T.Hooks.getRoot(r);
                            n = n || T.getPropertyValue(e, u), a = T.Hooks.injectValue(l, a, n), r = u } if (T.Normalizations.registered[r] && (a = T.Normalizations.registered[r]("inject", e, a), r = T.Normalizations.registered[r]("name", e)), s = T.Names.prefixCheck(r)[0], m <= 8) try { e.style[s] = a } catch (e) { V.debug && console.log("Browser does not support [" + a + "] for [" + s + "]") } else { var c = o(e);
                            c && c.isSVG && T.Names.SVGAttribute(r) ? e.setAttribute(r, a) : e.style[s] = a } V.debug >= 2 && console.log("Set " + r + " (" + s + "): " + a) } return [s, a] }, flushTransformCache: function(e) { var t = "",
                        r = o(e); if ((m || V.State.isAndroid && !V.State.isChrome) && r && r.isSVG) { var a = function(t) { return parseFloat(T.getPropertyValue(e, t)) },
                ...
                function n(e, n) {
                    function i(i) { var c, d; if (l.begin && 0 === F) try { l.begin.call(y, y) } catch (e) { setTimeout(function() { throw e }, 1) }
                        if ("scroll" === N) { var m, h, S, P = /^x$/i.test(l.axis) ? "Left" : "Top",
                            ...
                            u = d } else if ("start" === N) {
                            (c = o(e)) && c.tweensContainer && !0 === c.isAnimating && (d = c.tweensContainer); var O = function(n, i) { var o, p = T.Hooks.getRoot(n),
                                    f = !1,
                                    m = i[0],
                                    h = i[1],
                                    y = i[2]; if (c && c.isSVG || "tween" === p || !1 !== T.Names.prefixCheck(p)[1] || T.Normalizations.registered[p] !== a) {
                                    ...
                                    switch (S) {
                                        ...
                                        case "*":
                                            m *= y; break;
                                        case "/":
                                            m = y / m } u[n] = { rootPropertyValue: f, startValue: y, currentValue: y, endValue: m, unitType: b, easing: h }, o && (u[n].pattern = o), V.debug && console.log("tweensContainer (" + n + "): " + JSON.stringify(u[n]), e) } else V.debug && console.log("Skipping [" + p + "] due to a lack of browser support.") }; for (var j in v)
                                if (v.hasOwnProperty(j)) { var q = T.Names.camelCase(j),
                                        L = function(t, r) { var a, i, o; return x.isFunction(t) && (t = t.call(e, n, A)), x.isArray(t) ? (a = t[0], !x.isArray(t[1]) && /^[\d-]/.test(t[1]) || x.isFunction(t[1]) || T.RegEx.isHex.test(t[1]) ? o = t[1] : x.isString(t[1]) && !T.RegEx.isHex.test(t[1]) && V.Easings[t[1]] || x.isArray(t[1]) ? (i = r ? t[1] : p(t[1], l.duration), o = t[2]) : o = t[1] || t[2]) : a = t, r || (i = i || l.easing), x.isFunction(a) && (a = a.call(e, n, A)), x.isFunction(o) && (o = o.call(e, n, A)), [a || 0, i, o] }(v[j]); if (b(T.Lists.colors, q)) { var M = L[0],
                                            $ = L[1],
                                            B = L[2]; if (T.RegEx.isHex.test(M)) { for (var W = ["Red", "Green", "Blue"], I = T.Values.hexToRgb(M), D = B ? T.Values.hexToRgb(B) : a, G = 0; G < W.length; G++) { var Q = [I[G]];
                                                $ && Q.push($), D !== a && Q.push(D[G]), O(q + W[G], Q) } continue } } O(q, L) }
                            u.element = e } u.element && (T.Values.addClass(e, "velocity-animating"), R.push(u), (c = o(e)) && ("" === l.queue && (c.tweensContainer = u, c.opts = l), c.isAnimating = !0), F === A - 1 ? (V.State.calls.push([R, y, l, null, k.resolver, null, 0]), !1 === V.State.isTicking && (V.State.isTicking = !0, f())) : F++) } var s, l = g.extend({}, V.defaults, w),
                        u = {}; switch (o(e) === a && V.init(e), parseFloat(l.delay) && !1 !== l.queue && g.queue(e, l.queue, function(t) { V.velocityQueueEntryFlag = !0; var r = V.State.delayedElements.count++;
                        V.State.delayedElements[r] = e; var a = function(e) { return function() { V.State.delayedElements[e] = !1, t() } }(r);
                        ...
                        if (l.delay) { var c = V.State.delayedElements.count++;
                            V.State.delayedElements[c] = e; var d = function(e) { return function() { V.State.delayedElements[e] = !1, i() } }(c);
                            o(e).delayBegin = (new Date).getTime(), o(e).delay = parseFloat(l.delay), o(e).delayTimer = { setTimeout: setTimeout(i, parseFloat(l.delay)), next: d } } else i();
                    else g.queue(e, l.queue, function(e, t) { if (!0 === t) return k.promise && k.resolver(y), !0;
                        V.velocityQueueEntryFlag = !0, i(e) }); "" !== l.queue && "fx" !== l.queue || "inprogress" === g.queue(e)[0] || g.dequeue(e) } var u, c, m, h, y, v, w, P = arguments[0] && (arguments[0].p || g.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || x.isString(arguments[0].properties));
                x.isWrapped(this) ? (c = !1, h = 0, y = this, m = this) : (c = !0, h = 1, y = P ? arguments[0].elements || arguments[0].e : arguments[0]); var k = { promise: null, resolver: null, rejecter: null }; if (c && V.Promise && (k.promise = new V.Promise(function(e, t) { k.resolver = e, k.rejecter = t })), P ? (v = arguments[0].properties || arguments[0].p, w = arguments[0].options || arguments[0].o) : (v = arguments[h], w = arguments[h + 1]), y = i(y)) { var A = y.length,
                        F = 0; if (!/^(stop|finish|finishAll|pause|resume)$/i.test(v) && !g.isPlainObject(w)) { w = {}; for (var E = h + 1; E < arguments.length; E++) x.isArray(arguments[E]) || !/^(fast|normal|slow)$/i.test(arguments[E]) && !/^\d/.test(arguments[E]) ? x.isString(arguments[E]) || x.isArray(arguments[E]) ? w.easing = arguments[E] : x.isFunction(arguments[E]) && (w.complete = arguments[E]) : w.duration = arguments[E] } var N; switch (v) {
                        case "scroll":
                            N = "scroll"; break;
                        case "reverse":
                            N = "reverse"; break;
                        case "pause":
                            var H = (new Date).getTime(); return g.each(y, function(e, t) { s(t, H) }), g.each(V.State.calls, function(e, t) { var r = !1;
                                t && g.each(t[1], function(e, n) { var i = w === a ? "" : w; return !0 !== i && t[2].queue !== i && (w !== a || !1 !== t[2].queue) || (g.each(y, function(e, a) { if (a === n) return t[5] = { resume: !1 }, r = !0, !1 }), !r && void 0) }) }), e();
                        case "resume":
                            return g.each(y, function(e, t) { l(t, H) }), g.each(V.State.calls, function(e, t) { var r = !1;
                                t && g.each(t[1], function(e, n) { var i = w === a ? "" : w; return !0 !== i && t[2].queue !== i && (w !== a || !1 !== t[2].queue) || (!t[5] || (g.each(y, function(e, a) { if (a === n) return t[5].resume = !0, r = !0, !1 }), !r && void 0)) }) }), e();
                        case "finish":
                        case "finishAll":
                        case "stop":
                            g.each(y, function(e, t) { o(t) && o(t).delayTimer && (clearTimeout(o(t).delayTimer.setTimeout), o(t).delayTimer.next && o(t).delayTimer.next(), delete o(t).delayTimer), "finishAll" !== v || !0 !== w && !x.isString(w) || (g.each(g.queue(t, x.isString(w) ? w : ""), function(e, t) { x.isFunction(t) && t() }), g.queue(t, x.isString(w) ? w : "", [])) }); var O = []; return g.each(V.State.calls, function(e, t) { t && g.each(t[1], function(r, n) { var i = w === a ? "" : w; if (!0 !== i && t[2].queue !== i && (w !== a || !1 !== t[2].queue)) return !0;
                                    g.each(y, function(r, a) { if (a === n)
                                            if ((!0 === w || x.isString(w)) && (g.each(g.queue(a, x.isString(w) ? w : ""), function(e, t) { x.isFunction(t) && t(null, !0) }), g.queue(a, x.isString(w) ? w : "", [])), "stop" === v) { var s = o(a);
                                                s && s.tweensContainer && !1 !== i && g.each(s.tweensContainer, function(e, t) { t.endValue = t.currentValue }), O.push(e) } else "finish" !== v && "finishAll" !== v || (t[2].duration = 1) }) }) }), "stop" === v && (g.each(O, function(e, t) { d(t, !0) }), k.promise && k.resolver(y)), e();
                        default:
                            if (!g.isPlainObject(v) || x.isEmptyObject(v)) { if (x.isString(v) && V.Redirects[v]) { var j = (u = g.extend({}, w)).duration,
                                        q = u.delay || 0; return !0 === u.backwards && (y = g.extend(!0, [], y).reverse()), g.each(y, function(e, t) { parseFloat(u.stagger) ? u.delay = q + parseFloat(u.stagger) * e : x.isFunction(u.stagger) && (u.delay = q + u.stagger.call(t, e, A)), u.drag && (u.duration = parseFloat(j) || (/^(callout|transition)/.test(v) ? 1e3 : S), u.duration = Math.max(u.duration * (u.backwards ? 1 - e / A : (e + 1) / A), .75 * u.duration, 200)), V.Redirects[v].call(t, t, u || {}, e, A, y, k.promise ? k : a) }), e() } var L = "Velocity: First argument (" + v + ") was not a property map, a known action, or a registered redirect. Aborting."; return k.promise ? k.rejecter(new Error(L)) : t.console && console.log(L), e() } N = "start" } var z = { lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null },
                        R = [];
                    g.each(y, function(e, t) { x.isNode(t) && n(t, e) }), (u = g.extend({}, V.defaults, w)).loop = parseInt(u.loop, 10); var M = 2 * u.loop - 1; if (u.loop)
                        for (var $ = 0; $ < M; $++) { var B = { delay: u.delay, progress: u.progress };
                            $ === M - 1 && (B.display = u.display, B.visibility = u.visibility, B.complete = u.complete), C(y, "reverse", B) }
                    return e() } k.promise && (v && w && !1 === w.promiseRejectEmpty ? k.resolver() : k.rejecter()) };
            (V = g.extend(C, V)).animate = C; var A = t.requestAnimationFrame || h; if (!V.State.isMobile && r.hidden !== a) { var F = function() { r.hidden ? (A = function(e) { return setTimeout(function() { e(!0) }, 16) }, f()) : A = t.requestAnimationFrame || h };
                F(), r.addEventListener("visibilitychange", F) } return e.Velocity = V, e !== t && (e.fn.velocity = C, e.fn.velocity.defaults = V.defaults), g.each(["Down", "Up"], function(e, t) { V.Redirects["slide" + t] = function(e, r, n, i, o, s) { var l = g.extend({}, r),
                        u = l.begin,
                        c = l.complete,
                        p = {},
                        f = { height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: "" };
                    l.display === a && (l.display = "Down" === t ? "inline" === V.CSS.Values.getDisplayType(e) ? "inline-block" : "block" : "none"), l.begin = function() { 0 === n && u && u.call(o, o); for (var r in f)
                            if (f.hasOwnProperty(r)) { p[r] = e.style[r]; var a = T.getPropertyValue(e, r);
                                f[r] = "Down" === t ? [a, 0] : [0, a] }
                        p.overflow = e.style.overflow, e.style.overflow = "hidden" }, l.complete = function() { for (var t in p) p.hasOwnProperty(t) && (e.style[t] = p[t]);
                        n === i - 1 && (c && c.call(o, o), s && s.resolver(o)) }, V(e, f, l) } }), g.each(["In", "Out"], function(e, t) { V.Redirects["fade" + t] = function(e, r, n, i, o, s) { var l = g.extend({}, r),
                        u = l.complete,
                        c = { opacity: "In" === t ? 1 : 0 };
                    0 !== n && (l.begin = null), l.complete = n !== i - 1 ? null : function() { u && u.call(o, o), s && s.resolver(o) }, l.display === a && (l.display = "In" === t ? "auto" : "none"), V(this, c, l) } }), V } jQuery.fn.velocity = jQuery.fn.animate }(window.jQuery || window.Zepto || window, window, window ? window.document : void 0) });
$(document).ready(function() {
    function e() { t.velocity({ scaleY: .1 }, { delay: 300, duration: 0 }), a.velocity({ scaleY: .1 }, { delay: 300, duration: 0 }), t.velocity({ scaleY: 1 }, { delay: 100, duration: 0 }), a.velocity({ scaleY: 1 }, { delay: 100, duration: 0 }), t.velocity({ scaleY: .1 }, { delay: 100, duration: 0 }), a.velocity({ scaleY: .1 }, { delay: 100, duration: 0 }), t.velocity({ scaleY: 1 }, { delay: 200, duration: 0 }), a.velocity({ scaleY: 1 }, { delay: 200, duration: 0 });
        setTimeout(e, i);
        i += 300 } var a = $(".left-eye"),
        t = $(".right-eye"),
        o = $(".right-eyebrow"),
        l = $(".left-eyebrow");
    t.css("transform-origin", "50% 50%"), a.css("transform-origin", "50% 50%"); var i = Math.floor(6e3 * Math.random()) + 1e3;
    e(), $("svg").on("mouseenter", function() { o.velocity({ translateY: -10 }, { delay: 0, duration: 300 }), l.velocity({ translateY: 2.5 }, { delay: 0, duration: 300 }) }), $("svg").on("mouseleave", function() { o.velocity({ translateY: 0 }, { delay: 0, duration: 200 }), l.velocity({ translateY: 0 }, { delay: 0, duration: 200 }) }) });